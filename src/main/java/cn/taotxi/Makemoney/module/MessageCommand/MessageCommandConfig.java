...
public class MessageCommandConfig extends ConfigManager {
    ...
    public ConfigArray    messageRules = new ConfigArray("messageRules", new JsonArray(), "消息规则", this);
    ...
    public MessageRule getRule(int index) {
        return messageRules.get(index, MessageRule.class);
    }

    public List<MessageRule> getRules() {
        return messageRules.getValueAsList(MessageRule.class);
    }
